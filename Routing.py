...
def route(p1, p2, nodes, nodeEdges, risk):
    ...
    paths.append(findPath(nodes[startNode], nodes[endNode], nodes, nodeEdges, risk, 0, 100, 0.5))
    paths.append(findPath(nodes[startNode], nodes[endNode], nodes, nodeEdges, risk, 0, 1, 0.01))
    return paths
